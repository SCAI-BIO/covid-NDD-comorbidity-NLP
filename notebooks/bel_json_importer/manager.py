...
from constants import normalized_pmod, bel_func_short, NODES, EDGES
from n4j_structure import node_map, edge_map
from n4j_meta import Neo4jClient, Node, Edge
...
class Neo4jImporter:
    ...
    def __init__(self, file_path, n4j_client: Neo4jClient = None):
        ...
        self.client: Neo4jClient = n4j_client
